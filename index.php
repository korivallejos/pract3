  ...
  <div class = "container">
    ...
    <table class="table table-striped table-responsive">
      ...
      <tbody>
        ...
        $cadenaSQL = "select A.nombre, A.apellido, A.direccion, A.telefijo, A.telefmovi, A.email, D.nombre as distrito from distritos D join agenda A ON D.idDis = A.distrito
        ";
