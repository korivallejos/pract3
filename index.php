  ...
  <div class = "container">
    ...
    <table class="table table-striped table-responsive">
      ...
      <tbody>
        ...
        $cadenaSQL = "SELECT a.nombre, a.apellido, a.direccion, a.telefijo, a.telefmovi, a.email, d.dis_nombre
        FROM agenda a
        INNER JOIN distritos d ON a.distrito_id = d.idDis";
